        ...
        <div className={authStyles.formWrapper}>
            <form onSubmit={handleSubmit} className={authStyles.form}>
                <div className={authStyles.formHeader}>
                    ...
                    <p className={authStyles.subtitle}>새 계정을 만들어 서비스를 시작하세요</p>
                </div>
                ...
                <div className={authStyles.signupPrompt}>
                    ...
                    <button type="button" onClick={onSwitchToLogin} className={authStyles.signupLink} disabled={loading}>
                        로그인
                    </button>
                </div>
            </form>
