...
export const allEvents: ExamEvent[] = [
    ...
    { startdate: "2025-07-25", enddate: "2025-07-31", label: "d", type: "doc-reg", certificate: "기계정비산업기사" },
    ...
    { startdate: "2025-09-05", enddate: "2025-09-11", label: "d", type: "prac-reg", certificate: "기계정비산업기사" },
...
export function getColor(certificate: string): string {
    if (!colorMap[certificate]) {
        colorMap[certificate] = `hsl(${Math.floor(Math.random() * 360)}, 70%, 60%)`
    }
